 ...
 */
package org.opendaylight.blockstore.cli.commands;
...
public class BlockstoreCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(BlockstoreCliTestCommand.class);
    protected final BlockstoreCliCommands service;

    public BlockstoreCliTestCommand(final BlockstoreCliCommands service) {
